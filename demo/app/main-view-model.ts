...
import {TNSPSPDFKit, TNSPSPDFKitActivity} from 'nativescript-pspdfkit';
...
export class HelloWorldModel extends Observable {
    ...
    constructor() {
        ...
        //this.pdfAsImage = imageSrc.fromNativeSource(this.pspdfkit.display('~/example.pdf'))
        const pspdf = new TNSPSPDFKitActivity(this.licenseKey)
        pspdf.display('~/example.pdf')
    }
